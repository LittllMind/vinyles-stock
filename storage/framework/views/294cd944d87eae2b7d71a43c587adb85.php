<?php $__env->startSection('title', 'Mes Commandes - Fundisc'); ?>
        ...
        <div class="space-y-4">
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-800/50 border border-gray-700 rounded-2xl p-6 hover:border-purple-500/50 transition">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                <span class="text-lg font-bold text-purple-400"><?php echo e($order->numero_commande); ?></span>
                                <span class="text-sm text-gray-500">•</span>
                                <span class="text-sm text-gray-400"><?php echo e($order->created_at->format('d/m/Y')); ?></span>
                            </div>
                            <div class="flex items-center gap-2 mb-2">
                                <?php
                                ...
                                ?>
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium <?php echo e($badgeClass); ?>">
                                    <?php echo e($badgeIcon); ?> <?php echo e($order->statutLabel()); ?>

                                </span>
                            </div>
                            <div class="text-gray-400 text-sm">
                                <?php echo e($order->items->count()); ?> article(s) • 
                                <span class="font-semibold text-purple-400"><?php echo e(number_format($order->total, 2, ',', ' ')); ?> €</span>
                            </div>
                        </div>

                        <!-- Détail -->
                        <a href="#" 
                           onclick="document.getElementById('order-<?php echo e($order->id); ?>').classList.toggle('hidden')"
                    ...
                    <!-- Détails cachés -->
                    <div id="order-<?php echo e($order->id); ?>" class="hidden mt-6 pt-6 border-t border-gray-700">
                            ...
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-4 bg-gray-900/50 rounded-xl p-3">
                                    <?php if($item->vinyle): ?>
                                        ...
                                        <div class="flex-1">
                                            <div class="font-medium text-gray-300"><?php echo e($item->titre_vinyle); ?></div>
                                            <div class="text-sm text-gray-500">
                                                <?php echo e($item->quantite); ?> × <?php echo e(number_format($item->prix_unitaire, 2, ',', ' ')); ?> €
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.kiosque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/orders/my-orders.blade.php ENDPATH**/ ?>