        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden sm:flex items-center gap-6">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('orders.my')); ?>" class="hover:text-purple-400 transition">Mes commandes</a>
            ...
            <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" x-cloak class="sm:hidden mt-4 space-y-2">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('orders.my')); ?>" class="block hover:text-purple-400 py-2">Mes commandes</a>
...
</html><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/layouts/app.blade.php ENDPATH**/ ?>