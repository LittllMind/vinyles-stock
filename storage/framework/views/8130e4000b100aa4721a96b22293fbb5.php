...
<?php $__env->startSection('title', 'Catalogue - Vinyle Hydrodécoupé'); ?>

<?php $__env->startSection('content'); ?>

<?php if(empty($vinylesData)): ?>
...
<?php else: ?>
    <!-- <?php echo e(count($vinylesData)); ?> vinyles chargés -->
<?php endif; ?>

<div x-data="kiosqueComponent(<?php echo \Illuminate\Support\Js::from($vinylesData)->toHtml() ?>)" class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="<?php echo e(route('cart.index')); ?>" class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 px-6 py-3 rounded-2xl font-semibold transition flex items-center justify-center gap-2">
            🛒 Mon Panier <span class="bg-white/20 px-2 py-0.5 rounded-full text-sm"><?php echo e($cartCount); ?></span>
        </a>
    </div>
    ...
    <div class="fixed inset-x-4 bottom-4 sm:hidden">
        <a href="<?php echo e(route('cart.index')); ?>"
            ...
            🛒 Voir mon panier (<?php echo e($cartCount); ?>)
        </a>
    </div>
    ...
    <div x-show="selectedVinyle !== null" x-cloak
        ...
        <div class="bg-gray-800 rounded-2xl p-6 max-w-md w-full border border-gray-700 shadow-xl"
            ...
            <!-- Formulaire caché -->
            <form x-ref="addToCartForm" action="<?php echo e(route('cart.add')); ?>" method="POST" class="hidden">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.kiosque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/kiosque.blade.php ENDPATH**/ ?>