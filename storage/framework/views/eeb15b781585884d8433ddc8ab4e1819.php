<?php $__env->startSection('title', 'Dashboard - Fundisc'); ?>
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-400 mt-2">Rôle : <span class="text-purple-400"><?php echo e(Auth::user()->getRoleLabel()); ?></span></p>
    </div>
    ...
    <?php if(auth()->guard()->check()): ?>
        <?php if(Auth::user()->isEmployeOrAdmin()): ?>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- Stock Vinyles -->
                <a href="<?php echo e(route('vinyles.index')); ?>" 
                ...
                <a href="<?php echo e(route('mouvements.index')); ?>" 
                   class="group bg-gray-800/50 border border-gray-700 rounded-2xl p-6 hover:border-pink-500/50 hover:bg-gray-800 transition">
                    <div class="text-4xl mb-3">📋</div>
                ...
                <!-- Stock Fonds -->
                <a href="<?php echo e(route('fonds.index')); ?>" 
                   class="group bg-gray-800/50 border border-gray-700 rounded-2xl p-6 hover:border-pink-500/50 hover:bg-gray-800 transition">
                    <div class="text-4xl mb-3">🎨</div>
                ...
                <!-- Ventes -->
                <a href="<?php echo e(route('ventes.index')); ?>" 
                   class="group bg-gray-800/50 border border-gray-700 rounded-2xl p-6 hover:border-pink-500/50 hover:bg-gray-800 transition">
                    <div class="text-4xl mb-3">💰</div>
...
<?php echo $__env->make('layouts.kiosque', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/dashboard.blade.php ENDPATH**/ ?>