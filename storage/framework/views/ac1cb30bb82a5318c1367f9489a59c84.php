<?php $__env->startSection('title', 'Commande - Livraison'); ?>

<?php $__env->startSection('content'); ?>
<div x-data="{ 
    facturationDifferent: <?php echo e(($tempBilling && $tempBilling != $tempShipping) || old('use_same_address') === '0' ? 'true' : 'false'); ?>,
    useSameAddress: <?php echo e(old('use_same_address') === '0' ? 'false' : 'true'); ?>,
    selectedAddressId: '',
    saveNewAddress: <?php echo e(old('save_address') ? 'true' : 'false'); ?>,
    addressLabel: '<?php echo e(old('address_label', 'Maison')); ?>',
    
    loadAddress(addressId) {
        if (!addressId) return;
        
        const addresses = <?php echo \Illuminate\Support\Js::from($addresses)->toHtml() ?>;
                        ...
                        <div class="mb-6 p-4 bg-gray-900 rounded-xl border border-gray-700">
                            ...
                            <select id="address_select" 
                                ...
                                <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($address->id); ?>" <?php echo e($address->is_default ? 'selected' : ''); ?>>
                                        <?php echo e($address->label); ?> - <?php echo e($address->adresse); ?>, <?php echo e($address->code_postal); ?> <?php echo e($address->ville); ?>

                                        <?php echo e($address->is_default ? ' (Par défaut)' : ''); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="nom" name="nom" required
                                        ...
                                        value="<?php echo e(old('nom', $tempShipping['nom'] ?? auth()->user()->name ?? '')); ?>">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" required
                                        ...
                                        value="<?php echo e(old('email', $tempShipping['email'] ?? auth()->user()->email ?? '')); ?>">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" id="telephone" name="telephone" required
                                    ...
                                    value="<?php echo e(old('telephone', $tempShipping['telephone'] ?? '')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 pt-4 border-t border-gray-700">
                            ...
                            <div>
                                ...
                                <input type="text" id="livraison_adresse" name="adresse" required
                                    ...
                                    value="<?php echo e(old('adresse', $tempShipping['adresse'] ?? '')); ?>">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="livraison_code_postal" name="code_postal" required pattern="[0-9]{5}"
                                        class="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
                                        placeholder="75001"
                                        value="<?php echo e(old('code_postal', $tempShipping['code_postal'] ?? '')); ?>">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="livraison_ville" name="ville" required
                                        class="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
                                        placeholder="Paris"
                                        value="<?php echo e(old('ville', $tempShipping['ville'] ?? '')); ?>">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="livraison_pays" name="pays" required
                                    ...
                                    <?php $pays = old('pays', $tempShipping['pays'] ?? 'FR') ?>
                                    <option value="FR" <?php echo e($pays == 'FR' ? 'selected' : ''); ?>>France</option>
                                    <option value="BE" <?php echo e($pays == 'BE' ? 'selected' : ''); ?>>Belgique</option>
                                    <option value="CH" <?php echo e($pays == 'CH' ? 'selected' : ''); ?>>Suisse</option>
                                    <option value="LU" <?php echo e($pays == 'LU' ? 'selected' : ''); ?>>Luxembourg</option>
                                    <option value="DE" <?php echo e($pays == 'DE' ? 'selected' : ''); ?>>Allemagne</option>
                                    <option value="OTHER" <?php echo e($pays == 'OTHER' ? 'selected' : ''); ?>>Autre</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 pt-4 border-t border-gray-700">
                            ...
                            <div>
                                ...
                                <textarea id="instructions" name="instructions" rows="3"
                                    ...
                                    placeholder="Code d'accès, digicode, étage, etc."><?php echo e(old('instructions', $tempShipping['instructions'] ?? '')); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div x-show="facturationDifferent" x-cloak class="space-y-4 pt-4 border-t border-gray-700">
                            ...
                            <div>
                                ...
                                <input type="text" id="facturation_nom" name="facturation_nom"
                                    ...
                                    value="<?php echo e(old('facturation_nom', $tempBilling['nom'] ?? '')); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="facturation_adresse" name="facturation_adresse"
                                    ...
                                    value="<?php echo e(old('facturation_adresse', $tempBilling['adresse'] ?? '')); ?>">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="facturation_code_postal" name="facturation_code_postal" pattern="[0-9]{5}"
                                        class="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
                                        placeholder="75001"
                                        value="<?php echo e(old('facturation_code_postal', $tempBilling['code_postal'] ?? '')); ?>">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="facturation_ville" name="facturation_ville"
                                        class="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
                                        placeholder="Paris"
                                        value="<?php echo e(old('facturation_ville', $tempBilling['ville'] ?? '')); ?>">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="facturation_pays" name="facturation_pays"
                                    ...
                                    <?php $factPays = old('facturation_pays', $tempBilling['pays'] ?? 'FR') ?>
                                    <option value="FR" <?php echo e($factPays == 'FR' ? 'selected' : ''); ?>>France</option>
                                    <option value="BE" <?php echo e($factPays == 'BE' ? 'selected' : ''); ?>>Belgique</option>
                                    <option value="CH" <?php echo e($factPays == 'CH' ? 'selected' : ''); ?>>Suisse</option>
                                    <option value="LU" <?php echo e($factPays == 'LU' ? 'selected' : ''); ?>>Luxembourg</option>
                                    <option value="DE" <?php echo e($factPays == 'DE' ? 'selected' : ''); ?>>Allemagne</option>
                                    <option value="OTHER" <?php echo e($factPays == 'OTHER' ? 'selected' : ''); ?>>Autre</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-700 sticky top-8">
                        ...
                        <div class="space-y-3 mb-6 max-h-64 overflow-y-auto">
                            <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-2 border-b border-gray-700">
                                    <div class="flex-1">
                                        <p class="text-sm font-medium text-white"><?php echo e($item->vinyle->titre ?? 'Vinyle inconnu'); ?></p>
                                        <p class="text-xs text-gray-400">Qté: <?php echo e($item->quantite); ?></p>
                                    </div>
                                    <p class="text-sm font-semibold text-violet-400">
                                        <?php echo e(number_format($item->prix_unitaire * $item->quantite, 2)); ?> €
                                    </p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <a href="<?php echo e(route('kiosque.index')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/orders/create.blade.php ENDPATH**/ ?>