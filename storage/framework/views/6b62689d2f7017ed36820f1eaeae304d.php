<?php $__env->startSection('title', 'Paiement - Commande'); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="<?php echo e(route('orders.create')); ?>" class="text-sm text-violet-400 hover:text-violet-300 transition-colors">
                            Modifier
                        </a>
                    </div>
                    
                    <div class="space-y-2 text-gray-300">
                        <p class="font-semibold text-white"><?php echo e($shipping['nom']); ?></p>
                        <p><?php echo e($shipping['adresse']); ?></p>
                        <p><?php echo e($shipping['code_postal']); ?> <?php echo e($shipping['ville']); ?></p>
                        <p><?php echo e($shipping['pays'] === 'FR' ? 'France' : ($shipping['pays'] === 'BE' ? 'Belgique' : ($shipping['pays'] === 'CH' ? 'Suisse' : ($shipping['pays'] === 'LU' ? 'Luxembourg' : ($shipping['pays'] === 'DE' ? 'Allemagne' : 'Autre'))))); ?></p>
                        <p class="text-sm text-gray-400 mt-2">
                            📧 <?php echo e($shipping['email']); ?> | 📱 <?php echo e($shipping['telephone']); ?>

                        </p>
                        <?php if(!empty($shipping['instructions'])): ?>
                            <p class="text-sm text-gray-400 mt-2 pt-2 border-t border-gray-700">
                                📝 Instructions : <?php echo e($shipping['instructions']); ?>
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center space-x-4 p-4 bg-gray-900 rounded-xl border border-gray-700">
                                ...
                                <!-- Infos vinyle -->
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-white"><?php echo e($item->vinyle->nom ?? 'Vinyle inconnu'); ?></h3>
                                    <p class="text-sm text-gray-400">Quantité : <?php echo e($item->quantite); ?></p>
                                    <p class="text-xs mt-1">
                                        <?php if($item->fond_id && $item->fond): ?>
                                            <span class="text-pink-400">
                                                ✨ Avec fond <?php echo e($item->fond->nom); ?> (+<?php echo e(number_format($item->fond->prix_achat, 2)); ?> €)
                                            </span>
                                        <?php else: ?>
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e(number_format($item->prix_unitaire, 2)); ?> € / unité</p>
                                </div>
                            </div>
                ...
                <div class="bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-700 sticky top-8">
                    ...
                    <div class="space-y-3 mb-6">
                        <div class="flex justify-between text-sm text-gray-400">
                            <span>Sous-total (<?php echo e($cart->items->count()); ?> article<?php echo e($cart->items->count() > 1 ? 's' : ''); ?>)</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aur-lien/.picoclaw/workspace/bougies-stock/resources/views/orders/payment.blade.php ENDPATH**/ ?>