...
<body class="bg-gray-900 text-gray-100 min-h-screen flex flex-col" x-data="{ mobileMenuOpen: false, adminMenuOpen: false, toastSession: {{ session('toast') ? json_encode(session('toast')) : 'null' }} }">
