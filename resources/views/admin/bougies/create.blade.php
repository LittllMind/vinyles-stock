            ...
            <form action="{{ route('admin.bougies.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="parfum" id="parfum" value="{{ old('parfum') }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="type_cire" id="type_cire"
                            ...
                            <option value="cire végétale" {{ old('type_cire') == 'cire végétale' ? 'selected' : '' }}>Cire végétale</option>
                            <option value="beeswax" {{ old('type_cire') == 'beeswax' ? 'selected' : '' }}>Cire d'abeille</option>
                        </select>
                    </div>

                    <div>
                        <label for="temps_brulure" class="block text-sm font-medium text-gray-700">Temps de brûlure (minutes)</label>
                        <input type="number" name="temps_brulure" id="temps_brulure" value="{{ old('temps_brulure') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="quantite" id="quantite" value="{{ old('quantite', 0) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="seuil_alerte" class="block text-sm font-medium text-gray-700">Seuil d'alerte stock</label>
                        <input type="number" name="seuil_alerte" id="seuil_alerte" value="{{ old('seuil_alerte', 5) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
