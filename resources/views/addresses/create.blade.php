...
<div class="min-h-screen bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-400">Ajoutez une nouvelle adresse à votre compte</p>
        </div>
            ...
            <form action="{{ route('addresses.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-4 pt-4 border-t border-gray-700">
                    ...
                    <div>
                        ...
                        <select id="pays" name="pays" required
                            ...
                            <option value="DE" {{ old('pays') === 'DE' ? 'selected' : '' }}>Allemagne</option>
                            <option value="OTHER" {{ old('pays') === 'OTHER' ? 'selected' : '' }}>Autre</option>
                        </select>
                        @error('pays')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                ...
                <div class="space-y-4 pt-4 border-t border-gray-700">
                    ...
                    <textarea id="instructions" name="instructions" rows="3"
                        ...
                        placeholder="Code d'accès, digicode, étage, etc.">{{ old('instructions') }}</textarea>
                    @error('instructions')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
