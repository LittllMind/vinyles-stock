    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-2xl p-6 border border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-200 mb-4">Caractéristiques</h3>
                    
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            <div class="text-gray-500">Matériau</div>
                            <div class="text-gray-300">Vinyle premium</div>
                        </div>
                        
                        <div>
                            <div class="text-gray-500">Technique</div>
                            <div class="text-gray-300">Hydrodécoupe</div>
                        </div>
                        
                        <div>
                            <div class="text-gray-500">Fabrication</div>
                            <div class="text-gray-300">Artisanale française</div>
                        </div>
                        
                        <div>
                            <div class="text-gray-500">Livraison</div>
                            <div class="text-gray-300">24-48h (France)</div>
                        </div>
                    </div>
                </div>
            </div>
